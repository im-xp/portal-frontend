...
export function ProjectProposalForm({ formData, errors, handleChange, fields }: SectionProps) {
  if (!fields || !fields.size || !fieldsProjectProposal.some(field => fields.has(field))) return null;
