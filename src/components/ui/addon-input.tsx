    ...
    return (
      <div className={cn("flex w-full items-center", containerClassName)}>
        <div className="flex rounded-md focus-within:ring-1 focus-within:ring-ring w-full">
          ...
          <input
            className={cn(
              "flex h-9 w-full rounded-md border border-input px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
