      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex flex-col gap-1 items-start justify-center">
          ...
          <p className="text-sm text-muted-foreground">
            Give your friends an auto-approval for upcoming IMXP events
          </p>
        </div>
          ...
          return (
            <div key={group.name} className="flex items-center gap-4">
              <div className="w-40 flex-shrink-0">
                <p className="text-sm text-foreground">{group.popup_name}</p>
              </div>
              <div className="flex-1 relative">
                <input
                  ...
                  value={link}
                  disabled
                  className="w-full px-3 py-2 pr-10 text-sm text-muted-foreground bg-card border border-border rounded-md cursor-default"
                />
                <Button
                  variant="ghost"
                  size="icon"
